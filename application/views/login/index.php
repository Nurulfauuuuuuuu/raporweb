    ...
    <div class="container-login">
        <div class="forms-container">
            <div class="signin">
                <form method="post" action="" class="sign-in-form">
                    <img src="<?php echo base_url() ?>assets/img/logoma.jpg" alt="" class="image-logo">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h1>MAS Al-Ma'arif</h1>
                    <p>
                        Sistem Informasi E-Rapor siswa
                    </p>
                </div>
                <!-- <img src="<?php echo base_url() ?>assets/img/mas.svg" class="image" alt="" /> -->
            </div>
        </div>
    </div>