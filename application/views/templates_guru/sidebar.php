        ...
        <ul class="c-sidebar-nav">
            ...
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link <?php if ($menu == 'nilai') echo 'c-active' ?>" href="<?= base_url('guru/nilai') ?>"> Input Nilai</a></li>
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link <?php if ($menu == 'prestasi') echo 'c-active' ?>" href="<?= base_url('guru/nilai') ?>"> Input Prestasi</a></li>
                </ul>
            </li>
            <!-- <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
