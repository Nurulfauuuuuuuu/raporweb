    ...
    <div class="card">
        <div class="card-body">
            ...
            <select class="form-control mb-2 mr-2" id="thn_ajaran" name="thn_ajaran">
                            ...
                            <?php if ($th->nama == $kl->tahun_ajaran) : ?>
                                <?php if ($th->nama == $kl->tahun_ajaran) : ?>
                                    <?php if ($th->id_tahun == $tahun_aktif['id_tahun']) : ?>
                                        <option value="<?php echo $th->id_tahun ?>" selected> Plih Kelas</option>
                                    <?php else : ?>
                                        <option value="<?php echo $th->id_tahun ?>"> Pilih Kelas </option>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        <?php endforeach; ?>
                ...
                <button onclick="lihatNilai()" class="btn btn-success mb-2 mr-2"><i class="fas fa-search"></i> Lihat</button> 
            </div>
            <div id="data-nilai">
