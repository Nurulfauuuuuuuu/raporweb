        ...
        <ul class="c-sidebar-nav">
            ...
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link <?php if ($menu == 'peserta') echo 'c-active' ?>" href="<?= base_url('admin/pesertadidik') ?>"> Data Kelas</a></li>
            ...
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link <?php if ($menu == 'prestasi') echo 'c-active' ?>" href="<?= base_url('admin/prestasi') ?>"> Prestasi</a></li>
                </ul>
            </li>
            <!-- <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
    ...
    <div class="c-wrapper c-fixed-components">
        <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
            ...
            <ul class="c-header-nav d-md-down-none">
                <li class="c-header-nav-item px-3">Sistem Informasi E-Rapor Siswa</li>
            </ul>
