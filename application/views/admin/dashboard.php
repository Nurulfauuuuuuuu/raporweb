...
<div class="container-fluid">
    ...
    <div class="alert alert-success" role="alert">
        ...
        <p>Selamat Datang <strong><?php echo $nama; ?></strong> di Sistem Informasi E-Rapor Siswa MAS Al-Ma'arif, Anda Login Sebagai <strong><?php echo $level; ?></strong></p>
        <hr>
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#controlpanelModal">
            ...
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Tahun Ajaran</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 text-info text-center">
                            <a href="<?php echo base_url('admin/guru') ?>" style="text-decoration:none">
                                <i class="text-info fas fa-4x fa-user"></i>
                        ...
                        <div class="col-md-3 text-info text-center">
                            <a href="<?php echo base_url('admin/pesertadidik') ?>" style="text-decoration:none">
                                <i class="text-info fas fa-4x fa-book"></i>
                                <p class="nav-link small text-info">Data Kelas</p>
                            </a>
                        </div>
                        <div class="col-md-3 text-info text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-info text-center">
                            <a href="<?php echo base_url('admin/prestasi') ?>" style="text-decoration:none">
                                <i class="text-info fas fa-4x fa-sort-numeric-down"></i>
                                <p class="nav-link small text-info">Input Prestasi</p>
                            </a>
                        </div>
                    </div>
                    <!-- <div class="row">
