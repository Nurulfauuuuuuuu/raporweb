...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-chalkboard"></i> Kelas</h1>
    </div>
    ...
    <?php endif; ?>
    <?php echo anchor('admin/kelas/input', '<button class="btn btn-sm btn-success mb-3"><i class="fas fa-plus fa-sm"></i> Tambah Data</button>') ?>
