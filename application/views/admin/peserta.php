<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-users"></i> Data Kelas <?= $thn = ($tahun) ? $tahun['nama'] : '(Tidak Ada Tahun Ajaran Yang Aktif)';  ?></h1>
    </div>
    ...
    <?php endif; ?>
    <?php echo anchor('admin/pesertadidik/input', '<button class="btn btn-sm btn-success mb-3 mr-2" ' . $button . '><i class="fas fa-plus fa-sm"></i> Tambah Data</button>') ?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <button onclick="lihatPeserta()" class="btn btn-info" <?= $button ?>><i class="fas fa-search"></i> Lihat</button>
        </div>
    </div>
