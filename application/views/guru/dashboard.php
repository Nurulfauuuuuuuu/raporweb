<div class="container-fluid">
    ...
    <div class="alert alert-success" role="alert">
        ...
        <p>Selamat Datang <strong><?php echo $nama; ?></strong> di Sistem Informasi E-Rapor MAS Al-Ma'arif, Anda Login Sebagai <strong><?php echo $level; ?></strong></p>
        <hr>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Jabatan Mengajar</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 text-info text-center">
                            <a href="<?php echo base_url('guru/prestasi') ?>" style="text-decoration:none">
                                <i class="text-info fas fa-4x fa-sort-numeric-down"></i>
